...
const product = {
  ...
  images: [
    {
      src: "celestia(borsasechiello).jpeg",
      
    },
    {
      src: "celestia(borsasechiello)1.jpeg",
     
    },
    {
      src: "celestia(borsasechiello)2.jpeg",
     
    },
    {
      src: "celestia(borsasechiello)3.jpeg",
  ...
  description: "Borsa a secchiello in pelle testurizzata bicolore Marcie",
  highlights: [
    "Lunghezza min (tracolla/cinturino): 78.5 cm/30.9 in",
    "Altezza manico: 7 cm/2.8 in",
    "Profondità: 14.5 cm/5.7 in",
    "Lunghezza max (tracolla/cinturino): 104 cm/40.9 in",
  ],
  details:
