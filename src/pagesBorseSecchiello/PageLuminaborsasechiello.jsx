...
const product = {
  ...
  images: [
    {
      src: "lumina(borsasechiello).jpeg",
      
    },
    {
      src: "lumina(borsasechiello)1.jpeg",
     
    },
    {
      src: "lumina(borsasechiello)2.jpeg",
     
    },
    {
      src: "lumina(borsasechiello)3.jpeg",
      
    },
  ],
  colors: [
    { name: "White", class: "bg-white ", selectedClass: "bg-white" },
  ],
  description: "Borsa a Secchiello LUMINA in pelle testurizzata Bea",
  highlights: [
    "Profondità: 10 cm/3.9 in",
    "Lunghezza max (tracolla/cinturino): 124.5 cm/49 in",
    "Altezza: 17 cm/6.7 in",
    "Larghezza: 27 cm/10.6 in",
  ],
  details:
